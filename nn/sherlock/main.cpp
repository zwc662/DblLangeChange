...
int main(int argc, char ** argv)
{
	...
	if((run_benchmark_no == 1515151515) || (run_all))
	{
	...
	if((run_benchmark_no == 15) || (run_all))
	{
		...
		sherlock_parameters.do_LP_certificate = true;
		    ...
		    input_interval.clear();
		    input_interval.resize(27);

                    /*
                    for(int j = 0; j < input_interval.size(); j++) {
                        if(j == 21) {input_interval[j].push_back(-1.0);input_interval[j].push_back(0.0);}
                        else if(j == 27 && false) {input_interval[j].push_back(0.0);input_interval[j].push_back(5.0);}
                        else {input_interval[j].push_back(-20.0);input_interval[j].push_back(20.0);}
                    }
                    */
                    ...
                    for(int j = 0; j < 27; j++){
                        switch(j%10) {
                            //LNGREF
                            //case 0: input_interval[j].push_back(0); input_interval[j].push_back(13.4112);
                            case 0: input_interval[j].push_back(10); input_interval[j].push_back(13.4112);
                            //LTRLREF
                            //case 1: input_interval[j].push_back(-2.3741); input_interval[j].push_back(3.1250);
                            case 1: input_interval[j].push_back(0.0); input_interval[j].push_back(0.0);
                            //XDOT_DATA
                            //case 2: input_interval[j].push_back(0); input_interval[j].push_back(13.4112);
                            case 2: input_interval[j].push_back(5.4); input_interval[j].push_back(5.5);
                            //Y
                            // case 3: input_interval[j].push_back(-18.2683); input_interval[j].push_back(6.9740);
                            case 3: input_interval[j].push_back(5.0); input_interval[j].push_back(5.0);
                            //YDOT
                            //case 4: input_interval[j].push_back(-2.2433); input_interval[j].push_back(2.0003);
                            case 4: input_interval[j].push_back(-2.2433); input_interval[j].push_back(2.0003);
                            //PSI
                            //case 5: input_interval[j].push_back(-0.7667); input_interval[j].push_back(0.9337);
                            case 5: input_interval[j].push_back(-1.0); input_interval[j].push_back(0.2);
                            //R 
                            //case 6: input_interval[j].push_back(-0.7798); input_interval[j].push_back(0.8287);
                            case 6: input_interval[j].push_back(0.0); input_interval[j].push_back(0.1);
                            //STR_CMD
                            //case 7: input_interval[j].push_back(-1.0000); input_interval[j].push_back(1.0000);
                            case 7: input_interval[j].push_back(0.0); input_interval[j].push_back(0.0);
                            //ACC_CMD
                            //case 8: input_interval[j].push_back(0.0); input_interval[j].push_back(1.0000);
                            case 8: input_interval[j].push_back(1.0000); input_interval[j].push_back(1.0000);
                            //BRK
                            case 9: input_interval[j].push_back(0.0); input_interval[j].push_back(0.0);
                            default:
                                    input_interval[j].push_back(0.0); input_interval[j].push_back(10.0);
                        }
                    }
		    ...
		    create_constraint_from_interval(input_constraints, input_interval);
                    ...
                    cout << "wid: " << input_constraints.size() << " len: " << input_constraints[0].size() << endl;
                    for(auto i = input_constraints.begin(); i != input_constraints.end(); i++) {
